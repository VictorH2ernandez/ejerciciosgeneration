//funcion es un bloque de codigos que se pueden reutilizar de manera continua especificada para hacer una tarea
...
const compra = parseInt(prompt("Insertar total de compra"));

if(compra < 100){
    console.log("Hay descuento");
    document.write("Hay descuento");
}
else if(compra >=100 && compra<200){
    console.log("Segundo descuento");
}
